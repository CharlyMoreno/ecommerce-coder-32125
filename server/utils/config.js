...
const ORDENES_PERSISTENCIA = process.env.ORDENES_PERSISTENCIA || 'MongoDB'
const CATEGORIA_PERSISTENCIA = process.env.CATEGORIA_PERSISTENCIA || 'MongoDB'
const MENSAJES_PERSISTENCIA = process.env.MENSAJES_PERSISTENCIA || 'MongoDB'
...
module.exports = {
    ...
    USERS_PERSISTENCIA,
    CATEGORIA_PERSISTENCIA,
    ORDENES_PERSISTENCIA,
    MENSAJES_PERSISTENCIA
}